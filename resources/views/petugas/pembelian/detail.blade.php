    ...
    @foreach($daftarProduk as $produk)
        <div class="d-flex justify-content-between border-bottom py-2">
            <div>
                ...
                <small class="text-muted">Rp. {{ number_format($produk['price']) }} x {{ $produk['jumlah'] }}</small>
            </div>
...
<input type="hidden" name="total_payment" value="{{ $produk['subtotal'] }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="total_payment" class="form-control" value="{{ old('total_payment', $totalKeseluruhan) }}" required>
                            @error('total_payment')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>                                             
